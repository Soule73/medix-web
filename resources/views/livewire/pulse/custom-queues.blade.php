        ...
        <div class="grid gap-3 mx-px mb-px">
            ...
            <div wire:key="{{ $queue }}">
                ...
                <div class="mt-3 relative">
                    ...
                    <div wire:ignore class="h-14" x-data="queueChart({
                                    queue: '{{ $queue }}',
